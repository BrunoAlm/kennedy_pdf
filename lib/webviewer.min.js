! function (e, t) {
    ...
    return function (e) {
                ...
                function a(e, t) {
                    try {
                        ...
                        if (t && ("object" == s(t) || "function" == typeof t)) {
                            ...
                            if ("function" == typeof o) return void d(function (e, t) {
                                return function () {
                                    e.apply(t, arguments)
                                }
                            }(o, t), e)
        ...
        var a = {},
            s = 0;
        window.isPdfjs = !0, "undefined" == typeof console && (window.console = {
            log: function () {},
            warn: function () {},
            error: function () {}
        });
        var c = function () {
                for (var e = 1; e < arguments.length; e++)
                    for (var t = Object.keys(arguments[e]), n = 0; n < t.length; n++) arguments[0][t[n]] = arguments[e][t[n]];
                return arguments[0]
            },
            l = function (e) {
                var t = [];
        ...
        window.PDFNet && !a.skipPDFNetWebViewerWarning && console.warn("PDFNet.js and WebViewer.js have been included in the same context. See https://www.pdftron.com/kb_same_context for an explanation of why this could be an error in your application.");
        var u = new Map,
            f = new Map;
        a.WebViewer = function (e, t) {
            var n = this;
            if (f.get(t)) throw new Error("Two instances of WebViewer were created on the same HTML element. Please create a new element for each instance of WebViewer");
            f.set(t, !0);
            t.addEventListener("ready", (function e() {
                u.get(t).instance = n.getCompleteInstance(), t.removeEventListener("ready", e)
            })), this._validateOptions(e);
            var o = e.webviewerServerURL || e.pdftronServer;
            e.fullAPI && o && (e.forceClientSideInit || console.warn("The fullAPI and webviewerServerURL options have both been set so the forceClientSideInit option is now enabled. This means that WebViewer will switch to client side rendering and processing to allow use of the full API."), e.forceClientSideInit = !0), this.options = c({}, a.WebViewer.Options, e);
        ...
        a.WebViewer.prototype = {
            ...
            _create: function () {
                this.id = ++s, void 0 === this._trigger && (this._trigger = function (e, t) {
                    var n = d(e, t);
            ...
            _validateOptions: function (e) {
                for (var t = Object.keys(e), n = 0; n < t.length; n++) {
                    var o = t[n];
                    o in c({}, p, a.WebViewer.Options) || console.warn("".concat(o, " is not a valid option name. See http://r.pdftron.com/api/options_anchor for all available options."))
                }
                ...
                try {
                    ...
                    if (t.postMessage({
                        ...
                        var n = decodeURIComponent(this.options.initialDoc),
                            o = {
                                decrypt: t.CoreControls.Encryption.decrypt,
                                decryptOptions: this.options.encryption,
                                documentId: this.options.documentId,
                                extension: "xod"
                            };
                        this.loadDocument(n, o)
                    }
                } catch (e) {
            ...
            _createHTML5: function () {
                ...
                this.setInstanceData(n), n.id = "webviewer-".concat(this.id), n.src = t, n.title = "webviewer", n.frameBorder = 0, n.width = "100%", n.height = "100%", n.setAttribute("allowfullscreen", !0), n.setAttribute("webkitallowfullscreen", !0), n.setAttribute("mozallowfullscreen", !0), this.iframe = n, this.options.backgroundColor && n.setAttribute("data-bgcolor", this.options.backgroundColor), this.options.assetPath && n.setAttribute("data-assetpath", encodeURIComponent(this.options.assetPath)), this.loadListener = function () {
                    var t = e.iframe;
                    try {
                        e.instance = t.contentWindow.instance, void 0 === e.instance ? t.contentWindow.addEventListener("viewerLoaded", (function () {
                            e.instance = t.contentWindow.instance, e._viewerLoaded(t)
                        })) : e._viewerLoaded(t)
                    } catch (n) {
                        e._viewerLoaded(t)
                    }
            ...
            dispose: function () {
                u.delete(this.element), f.delete(this.element), this.instance.closeDocument(), window.removeEventListener("message", this.messageHandler), this.iframe.removeEventListener("load", this.loadListener), this.iframe = null
            },
        ...
        var h = function (e, t) {
                return new Promise((function (n, o) {
                    ...
                    t.addEventListener("ready", (function a() {
                        t.removeEventListener("ready", a);
                        try {
                            var l = t.querySelector("iframe").contentWindow;
                            if (void 0 === l.Tools) return o("Viewer isn't instantiated correctly. It could be caused by the 'path' option in the WebViewer constructor not being defined correctly. The 'path' option should be relative to the HTML file you're loading the script on and the lib folder needs to be publicly accessible.");
                            var d = s.getInstance(),
                                u = {
                                    iframeWindow: l,
                                    dispose: s.dispose.bind(s)
                                },
                                f = c({}, d, i(r({}, d.UI_NAMESPACE_KEY, i(i({}, d[d.UI_NAMESPACE_KEY]), u)), u));
                            s.setCompleteInstance(f);
                            var p = Promise.resolve();
                            e.documentXFDFRetriever && (p = f[d.CORE_NAMESPACE_KEY].documentViewer.setDocumentXFDFRetriever(e.documentXFDFRetriever)), p.then((function () {
                                n(f)
                            }))
                        } catch (e) {
                            o("Viewer is on a different domain, the promise from WebViewer function is rejected and API functions will not work because of cross domain permissions. See https://www.pdftron.com/kb_cross_origin for more information.")
                        }
                    }));
                    var s = new a.WebViewer(e, t)
                }))
            },
            m = function (e) {
        ...
        h.l = function (e) {
            var t = m(e);
            return t && t.l
        }, h.workerTransportPromise = function (e) {
            var t = m(e);
        ...
        var v = function (e) {
            ...
            return e ? (u.get(e) || {}).instance : (t[0] || {}).instance
        };
        h.getInstance = v, window.WebViewer = h, t.default = h
    }])
}));